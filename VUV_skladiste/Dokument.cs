        ...
        public static void IspisNajnovijihDokumenata()
        {
            ...
            for (i = 0; i < n - 1; i++)
            {
                for (int j = 0; j < n - i - 1; j++)
                {
                    ...
                    {
                        (dokuments[j + 1], dokuments[j]) = (dokuments[j], dokuments[j + 1]);
                    }
